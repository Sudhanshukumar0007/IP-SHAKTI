...
if os.environ.get("ENABLE_DEV_TRACE", "false").lower() != "true":
    st.error("Evaluation Dashboard is restricted to development mode. Set ENABLE_DEV_TRACE=true in your environment to access this page.")
    st.stop()
